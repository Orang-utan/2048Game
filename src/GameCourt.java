...
public class GameCourt extends JPanel {
    ...
    private Square square2; // the Black Square, keyboard control
     ...
     */
    public void reset() {
        square = new Square(COURT_WIDTH, COURT_HEIGHT, Color.BLUE, 0, 0);
        square2 = new Square(COURT_WIDTH, COURT_HEIGHT, Color.BLACK, 200, 0);
